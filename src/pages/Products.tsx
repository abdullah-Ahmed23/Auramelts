...
import { Filter, Search, X, Sparkles, ChevronDown, SlidersHorizontal } from 'lucide-react';
              ...
              <div className="flex flex-col">
                ...
                {categories.map((cat) => (
                  <button
                    ...
                    className="flex items-center gap-3 px-5 py-3 hover:bg-[#FDF8F4] transition-colors border-b border-[#FDF8F4] last:border-0"
                  >
                    <Checkbox
                      checked={activeCategory === cat.id}
                      className="border-[#E84A8A] data-[state=checked]:bg-[#E84A8A] data-[state=checked]:border-[#E84A8A]"
                    />
                    <span className={`text-sm font-bold ${activeCategory === cat.id ? 'text-[#E84A8A]' : 'text-[#7B4B94]/70'}`}>
                      {cat.name}
                    </span>
                  </button>
                ))}
            ...
            <AccordionContent className="p-5">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Checkbox id="instock" className="border-[#E84A8A] data-[state=checked]:bg-[#E84A8A]" />
                  <label htmlFor="instock" className="text-sm font-bold text-[#7B4B94]/70 cursor-pointer select-none">In Stock</label>
                </div>
                <div className="flex items-center gap-3">
                  <Checkbox id="outstock" className="border-[#E84A8A] data-[state=checked]:bg-[#E84A8A]" />
...
const Products = () => {
  ...
  }, [activeCategory, searchQuery, deferredPriceRange]);
